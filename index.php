...
EnderTheCoder  临沂第二十四中学-冯钰荃 参赛作品</br>
&copy; <?php echo date('Y');?> By EnderTheCoder. All rights reserved.</br>

 <a href="mailto:ggameinvader@gmail.com"><i class="fa fa-envelope" style="font-size:20px;"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;
 <a href="http://wpa.qq.com/msgrd?v=3&uin=1991455223&site=qq&menu=yes"><i class="fa fa-qq" style="font-size:20px;"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;
 <a href="https://github.com/enderthecoder"><i class="fa fa-github" style="font-size:20px;"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;
</center>
